...
chat_log.insert(tk.END, f"Recolectora: ¡Hola {user_name.capitalize()}! Soy Aracelly 😊. Pregúntame sobre variedades, precios, calidad, bonos de carbono, año de cosecha, productor o propiedades.")
...
def responder():
    ...
    respuesta = "Lo siento, no entendí tu pregunta. ¿Quieres saber sobre variedades, precios, calidad, año de cosecha, productor o propiedades?"
